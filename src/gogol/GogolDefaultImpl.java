...
public class GogolDefaultImpl implements Game, Observer{
	...
	private GogolLevelDefaultImpl currentPlayedLevel = null;
	...
	public void start() {
		...
		for (GameLevel level : gameLevels) {
			...
			try {
				...
				currentPlayedLevel = (GogolLevelDefaultImpl) level;
				levelNumber++;
	...
	public void update(Observable o, Object arg) {
		if (o == endOfGame) {
			...
			for (ObservableValue<Float> healthObservable : health){
